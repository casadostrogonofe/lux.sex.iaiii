    ...
    <section className="relative pt-32 md:pt-40 pb-20 overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        ...
        <h1 className="font-serif text-center text-[#f5f0ff] text-5xl md:text-7xl lg:text-[88px] leading-[1.05] mb-6">
          ...
          de <span className="italic bg-gradient-to-r from-[#9b30ff] via-[#b48cff] to-[#e6d5ff] bg-clip-text text-transparent">palavra</span>.
        </h1>

        <p className="text-center text-[#7c7893] max-w-2xl mx-auto text-base md:text-lg leading-relaxed mb-16 font-light">
        ...
        >
          <div className="grid lg:grid-cols-2">
            ...
            <div className="relative bg-[#0b0812] p-8 md:p-14 lg:p-16 flex flex-col justify-center">
              ...
              <div className="flex flex-wrap items-center gap-5 text-xs tracking-wider text-[#5a5470] uppercase mb-10">
